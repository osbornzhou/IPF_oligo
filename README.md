...
- Additional files 1-14 are provided through the journal submission system; in the full repository deposit package, they are also stored under `manuscript/additional_files/`.
...
- `manuscript/repository_deposit_package.zip`, when included in a release, is a ready-to-upload archive containing scripts, additional files, reproducibility metadata, figures, and manuscript artifacts.
