...
ADDITIONAL_CAPTIONS = {
    "S1": "Additional Figure S1. Integrated candidate prioritization. Scores combine robust differential expression, machine-learning evidence, pathway and network support, miRNA-axis evidence, single-cell localization, and oligonucleotide strategy compatibility.",
    ...
    "S11": "Additional Figure S11. Perturbation-triage score weight-sensitivity analysis. Candidate ranks were evaluated under equal weights, leave-one-layer-out scoring, and 1000 seeded +/-20% weight perturbation scenarios.",
    "S12": "Additional Figure S12. Donor-level pseudobulk dot/median plots. Each dot represents one donor-level pseudobulk value for the core comparisons displayed in Figure 5C; vertical bars mark group medians.",
    "S13": "Additional file 13. Disease-boundary stress-test plots. Excluded GSE110147 NSIP and mixed IPF-NSIP samples were scored without training use, and matched random discovery-feature panels contextualized the final-panel refit.",
    "S14": "Additional file 14. miRNA evidence-gate stress-test plots. miRTarBase target-set enrichment and hsa-miR-375 target release-like score were used to determine whether strict exact-axis findings should be expanded.",
    "6": "Figure 6. Perturbation-triage map. Candidate genes and miRNA-axis targets were organized into knockdown-screening candidates, context-dependent fibrotic disease-state markers, restoration or pathway markers, exact miRNA-axis hypotheses, and the externally motivated TNIK bridge. The validation-planning score is intended to organize experiments and should not be interpreted as therapeutic readiness or completed perturbation validation.",
}
