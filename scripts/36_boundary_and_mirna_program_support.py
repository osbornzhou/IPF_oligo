...
def draw_auc_stress_figure(disease_summary: pd.DataFrame, disease_scores: pd.DataFrame, matched: pd.DataFrame, matched_summary: pd.DataFrame) -> None:
    ...
    grey = (115, 123, 135)
    blue = (73, 118, 160)
    draw.text((80, 45), "Additional Figure S13. External disease-state performance stress tests", fill=(0, 0, 0), font=title)
...
def draw_mirna_program_figure(enrich: pd.DataFrame, repression: pd.DataFrame) -> None:
    ...
    blue = (73, 118, 160)
    grey = (115, 123, 135)
    draw.text((80, 45), "Additional Figure S14. miRNA target-program stress test", fill=(0, 0, 0), font=title)
