#!/usr/bin/env python
"""
Build an oligonucleotide-focused actionability index.
...
def plot_actionability(table: pd.DataFrame) -> None:
    ...
    ax.set_title("Oligonucleotide-focused actionability map")
...
def plot_actionability_pil(table: pd.DataFrame) -> None:
    ...
    draw.text((left, 70), "Oligonucleotide-focused actionability map", fill=(20, 20, 20), font=title_font)
