...
accessions are listed in the manuscript and in Additional file 1. The public
repository is available at https://github.com/osbornzhou/IPF_oligo. If the
project is later archived through Zenodo, the same folder structure can be
