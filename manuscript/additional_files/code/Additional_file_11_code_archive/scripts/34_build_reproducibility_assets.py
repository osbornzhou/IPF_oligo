...
def build_reproducibility_package() -> None:
    script_rows = [
        ...
        ("26_oligonucleotide_actionability_index.py", "Oligonucleotide validation-planning score and Figure 7", "integrated priority outputs", "results/oligonucleotide_actionability"),
        ...
        ("29_actionability_weight_sensitivity.py", "Actionability weight-sensitivity analysis", "actionability index", "results/oligonucleotide_actionability"),
        ("30_mirna_exact_axis_support_table.py", "Exact hsa-miR-375 axis cross-check table", "miRNA axes", "results/submission_enhancements"),
        ("31_build_pseudobulk_figure.py", "High-resolution Figure 6C pseudobulk panel", "pseudobulk summaries", "results/single_cell_pseudobulk"),
    ...
    seed_rows = [
        ...
        ("29_actionability_weight_sensitivity.py", "seeded +/-20% actionability weight perturbations", 20260526),
...
the IPF oligonucleotide-focused transcriptomic actionability manuscript.
...
and supplementary PDF plots are provided as Additional files 12-14. Public GEO
accessions are listed in the manuscript and in Additional file 1. If the authors
later archive the project on GitHub/Zenodo, the same folder structure can be
deposited directly with the generated outputs.
"""
