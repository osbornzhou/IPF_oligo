#!/usr/bin/env python
"""
Assess sensitivity of the oligonucleotide actionability index to weight choices.

The actionability score is intended for validation planning. This script checks
...
def build_sensitivity() -> None:
    ...
    draw.text((left, 35), "Actionability score weight-sensitivity analysis", fill=(0, 0, 0), font=font_title)
    plot_top = top
