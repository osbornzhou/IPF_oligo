...
This archive is prepared for public deposition of the IPF oligonucleotide-focused perturbation-triage Research article files.
...
- `editable_figures/`: editable SVG source files for main Figures 1-6, with an index page and manifest.
- `ipf_oligo_ml_bmc_genomics_research_article_submission_ready.docx`: editable BMC Genomics Research article submission manuscript.
- `ipf_oligo_ml_bmc_genomics_research_article_submission_ready.pdf`: reviewer preview PDF generated from the editable manuscript.
